...
class IDCardUtil {
        ...
        if (isNum(idCard)) {
            ...
            for (China value : China.values()) {
                if (value.code.equals(proCode)) {
                    ...
                    return validateDateSmllerThenNow(cal.get(Calendar.YEAR), Integer.valueOf(birthCode.substring(2, 4)),
    ...
    public static boolean validateTWCard(String idCard) {
        ...
        Integer iStart = 0;
        for (TaiWan value : TaiWan.values()) {
            if (value.mark == start) {
                iStart = value.code;
                break;
            }
    ...
    public static boolean validateHKCard(String idCard) {
        ...
        if (card.length() == 9) {
            sum = ((int) chars1[0] - 55) * 9 + ((int) card.substring(1, 2)
                    .toUpperCase()
                    .toCharArray()[0] -
                    55) * 8;
