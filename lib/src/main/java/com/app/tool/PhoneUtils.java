...
class PhoneUtils extends Util {
     ...
     * @return IMEI码
     */
    @RequiresPermission(value = Manifest.permission.READ_PRECISE_PHONE_STATE)
     ...
     */
    @RequiresPermission(allOf = {Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_SMS})
