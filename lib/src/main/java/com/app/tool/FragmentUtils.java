...
class FragmentUtils {
     ...
     */
    public static void clearAllFragment(@NonNull FragmentManager fragmentManager) {
        try {
     ...
     * @return fragment
     */
    public static Fragment addFragment(@NonNull FragmentManager fragmentManager, @NonNull Fragment fragment,
                                       @IdRes int containerId) {
        return addFragment(fragmentManager, fragment, containerId, false);
    }

    public static Fragment addFragment(@NonNull FragmentManager fragmentManager, @NonNull Fragment fragment, String tag,
                                       @IdRes int containerId) {
    ...
    public static Fragment addFragment(@NonNull FragmentManager fragmentManager, @NonNull Fragment fragment,
        ...
        putArgs(fragment, new Args(containerId, isHide, isAddStack));
        return operateFragment(fragmentManager, null, fragment, null, TYPE_ADD_FRAGMENT, sharedElement);
    }
     ...
     * @return fragment
     */
    public static Fragment hideAddFragment(@NonNull FragmentManager fragmentManager, @NonNull Fragment hideFragment,
        ...
        return operateFragment(fragmentManager, hideFragment, addFragment, null, TYPE_ADD_FRAGMENT, sharedElement);
    }
     ...
     * @return 要显示的fragment
     */
    public static Fragment addFragments(@NonNull FragmentManager fragmentManager, @NonNull List<Fragment> fragments,
     ...
     */
    public static void removeFragment(@NonNull Fragment fragment, boolean isIncludeSelf) {
        operateFragment(fragment.getFragmentManager(), isIncludeSelf ? fragment : null, fragment, null, TYPE_REMOVE_TO_FRAGMENT);
    }
     ...
     * @return fragment
     */
    public static Fragment replaceFragment(@NonNull FragmentManager fragmentManager, @NonNull Fragment fragment,
    ...
    public static Fragment replaceFragment(@NonNull FragmentManager fragmentManager, @NonNull Fragment fragment,
        ...
        putArgs(fragment, new Args(containerId, false, isAddStack));
        return operateFragment(fragmentManager, null, fragment, null, TYPE_REPLACE_FRAGMENT, sharedElement);
    }
     ...
     * @return fragment
     */
    public static Fragment popAddFragment(@NonNull FragmentManager fragmentManager, @NonNull Fragment fragment,
                                          @IdRes int containerId, boolean isAddStack) {
        putArgs(fragment, new Args(containerId, false, isAddStack));
    ...
    public static Fragment popAddFragment(@NonNull FragmentManager fragmentManager, @NonNull Fragment fragment,
        ...
        putArgs(fragment, new Args(containerId, false, isAddStack));
        return operateFragment(fragmentManager, null, fragment, null, TYPE_POP_ADD_FRAGMENT, sharedElements);
    }
    ...
    public static Fragment hideFragment(@NonNull Fragment fragment) {
        ...
        return operateFragment(fragment.getFragmentManager(), null, fragment, null, TYPE_HIDE_FRAGMENT);
    }
    ...
    public static Fragment showFragment(@NonNull Fragment fragment) {
        ...
        return operateFragment(fragment.getFragmentManager(), null, fragment, null, TYPE_SHOW_FRAGMENT);
    }
     ...
     * @return destFragment
     */
    private static Fragment operateFragment(@NonNull FragmentManager fragmentManager, Fragment srcFragment,
                                            @NonNull Fragment destFragment, String tag, int type, SharedElement... sharedElements) {
    ...
    private static List<FragmentNode> getAllFragmentsIsInStack(@NonNull FragmentManager fragmentManager,
                                                               List<FragmentNode> result, boolean isInStack) {
        List<Fragment> fragments = fragmentManager.getFragments();
        if (fragments == null || fragments.isEmpty()) {
            return Collections.emptyList();
        }
        for (int i = fragments.size() - 1; i >= 0; --i) {
            ...
            if (fragment != null) {
                if (isInStack) {
                    ...
                    result.add(new FragmentNode(fragment,
                            getAllFragmentsIsInStack(fragment.getChildFragmentManager(), new ArrayList<FragmentNode>(),
                                    false)));
                }
            }
        }
    ...
    public static boolean dispatchBackPress(@NonNull FragmentManager fragmentManager) {
        ...
        for (int i = fragments.size() - 1; i >= 0; --i) {
            Fragment fragment = fragments.get(i);
            if (fragment != null && fragment.isResumed() && fragment.isVisible() && fragment.getUserVisibleHint() &&
                    fragment instanceof OnBackClickListener && ((OnBackClickListener) fragment).onBackClick()) {
                return true;
            }
        }
        return false;
